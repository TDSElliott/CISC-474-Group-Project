...
flags.DEFINE_string('root_dir', "H:/Users/Shane/Documents/GitHub/474_Group_Project",
                    'Root directory for writing logs/summaries/checkpoints.')
flags.DEFINE_string(
    'data_path', 'H:/Users/Shane/Documents/GitHub/474_Group_Project/ml-100k/u.data',
    'Location of the movielens dataset. If you downloaded the dataset from Kaggle, set this param to the path of u.data file'
)
flags.DEFINE_enum(
    'agent', 'epsGreedy', ['LinUCB', 'LinTS', 'epsGreedy', 'DropoutTS'],
